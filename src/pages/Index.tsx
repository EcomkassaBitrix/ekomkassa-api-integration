            ...
            <div className="p-8">
              ...
              {activeSection === 'integrations' && (
                <IntegrationsSection
                  ...
                  apnsTeamId={providers.apnsTeamId}
                  setApnsTeamId={providers.setApnsTeamId}
                  apnsKeyId={providers.apnsKeyId}
                  setApnsKeyId={providers.setApnsKeyId}
                  apnsPrivateKey={providers.apnsPrivateKey}
                  setApnsPrivateKey={providers.setApnsPrivateKey}
                  apnsBundleId={providers.apnsBundleId}
                  setApnsBundleId={providers.setApnsBundleId}
                  smsAeroEmail={providers.smsAeroEmail}
                  setSmsAeroEmail={providers.setSmsAeroEmail}
                  smsAeroApiKey={providers.smsAeroApiKey}
